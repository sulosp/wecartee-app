...
export default function OngoingPromotions() {
  ...
  const totalPages = Math.ceil(
    BUSINESS_DIRECTORY_LIST.length / itemsPerPage
  );
  ...
  return (
    <div className="flex flex-col justify-between w-full h-full">
      ...
      <div className="flex justify-between items-center mt-4">
        ...
        <Link className="inline-flex justify-start gap-2 items-center" to="/ongoingpromotions">
          <span className="text-title-sm text-primary-400 text-center "> See All</span>
