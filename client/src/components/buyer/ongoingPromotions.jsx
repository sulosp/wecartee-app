  ...
  return (
    ...
    <div className="flex flex-col justify-between w-full h-full">
      ...
      {showPagination ? (
        <div id="pagination" className="flex justify-between items-center mt-4">
          <div className="inline-flex justify-start items-center gap-2">
            ...
            {Array.from({ length: totalPages }, (_, i) => (
              <button
                ...
                className={`class=" rounded-md items-center hover:bg-primary-100 p-10 text-title-sm font-semibold text-primary-400 focus-visible:outline-none " ${currentPage === i + 1 ? "bg-primary-100  " : "bg-white"
                  }`}
              >
                {i + 1}
              </button>
          ...
          <div className=" w-60 flex justify-end">
            <button className="inline-flex justify-start gap-2 items-center" onClick={handleSeeAllClick}>
      ...
      <div className="w-full justify-center items-center flex ">
        {!showPagination && (
          <button id="displayPagination" onClick={handleDisplayPaginationClick} className="mt-5 text-title-lg rounded-md items-center hover:bg-primary-100 p-2 font-semibold text-primary-400 focus-visible:outline-none bg-primary-100  ">
