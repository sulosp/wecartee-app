...
export default function SavedBusinessWidget() {
    ...
    return (
        <div className="flex w-1/2 flex-col justify-start items-start h-full bg-white gap-5 p-20 rounded-lg">
            <div>
            ...
            <div className="flex flex-row gap-5 flex-wrap h-15">
                {filteredBusinesses.map(savedBusiness => (
                    <img key={savedBusiness.key} src={savedBusiness.iconPath} alt={savedBusiness.business} className="w-15 h-15"/>
                ))}
