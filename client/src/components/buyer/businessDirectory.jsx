...
export default function BusinessDirectory() {
  return (
    <div className="gap-5 inline-flex justify-center items-start max-h-screen  p-24 bg-surface-100 w-full ">
      <div className="w-1/4  ">
        <SaveWidget />
      </div>


      <div className="w-full flex-col p-20 bg-white rounded-lg justify-start items-between h-auto bg-surface-100 ">
        <div className="inline-flex justify-between items-center w-full">
          <div className="flex flex-col justify-center items-start">
            <span className="text-primary-700 text-headline-sm">Business Directory</span>

            <span className="text-primary-400 text-body-md gap-1">{BUSINESS_DIRECTORY_LIST.length + (' Businesses')}</span>
        ...
        <table className="w-full mt-5">
          <thead>
            <tr className="w-full inline-flex justify-between items-center pb-14 border-surface-100 border-b " >
              <th className="basis-3/12 text-body-md text-primary-400 font-medium inline-flex justify-start items-center ">Business Name</th>
              <th className="basis-5/12 text-body-md text-primary-400 font-medium inline-flex justify-start items-center ">Category</th>
              <th className="basis-2/12 text-body-md text-primary-400 font-medium inline-flex justify-center items-center ">Products</th>
              <th className="basis-2/12 text-body-md text-primary-400 font-medium inline-flex justify-center items-center  ">Save</th>
            </tr>
          </thead>
          <tbody className="flex flex-col w-full justify-start items-center gap-2 mt-5">
            {BUSINESS_DIRECTORY_LIST.map((seller, index) => (
              <tr key={index} className="w-full inline-flex justify-between items-center ">
                ...
                <td className="text-[24px] flex basis-1/12 justify-center items-center basis-2/12">
